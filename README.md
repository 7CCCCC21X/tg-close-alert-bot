...
```text
🏛 证券交易所收盘价：514.98 CNY ≈ 72.2272 USD（1 USD = 7.13 CNY）｜收盘 09-18 15:00（北京时间）｜来源 上交所688836·自动
相对交易所（折美元）：🔴 +5.791%
```
...
```text
📈 恒指期货 恒指主连（夜市）：24,706 🟢 -30（-0.12%）｜低水 45（恒指 24,750.78）｜开 24,739 高 24,755 低 24,610｜09-18 22:01 更新（东方财富）
```
