...
```text
📈 恒指期货 夜市 24,706 → 恒指收盘 24,750.78 🟢 -0.18%（低水 45）｜恒指当日 🔴 +0.60%｜期货昨结 🟢 -0.12%（-30）｜09-18 22:01 东方财富
```

箭头后是期货价相对恒生指数的偏差：港股现货时段（09:30–16:10）对比实时恒指，收市后对比当天恒指收盘，括号里是高水/低水点数；“恒指当日”是恒指自身相对昨收的涨跌，“期货昨结”是期货相对上一结算价。
